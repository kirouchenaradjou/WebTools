...
<title>Insurance | User Login</title>
...
<body>
	<div id="site-content">
		...
		<div class="top-header">
			<div class="container">
				<a href="${contextPath}/insurance/login.htm" id="branding"> <img src="${contextPath}/images/logo.png"
		...
		<div class="bottom-header">
			<div class="container">
				<div class="main-navigation">
					...
					<ul class="menu">
						<li class="menu-item"><a href="${contextPath}/insurance/userForgotpassword.htm">Forgot User Name?</a></li>
						<li class="menu-item"><a href="insurance.html">Insurance
								plans</a></li>
						<li class="menu-item"><a href="${contextPath}/insurance/userCreate.htm">Register New User</a></li>
		...
		<div class="breadcrumbs">
			<div class="container">
				<a href="${contextPath}/insurance/login.htm">Home</a> <span>User Login</span>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-md-3">
						...
						<div class="contact-detail">
							<address>
								<p>
									Company Name INC. <br> 523 Burt Street, Omaha
								</p>

								<p>Phone: +1 823 424 9134 info@company.com</p>
							</address>
						</div>
					</div>
					<div class="col-md-9">
						<h2 class="section-title text-left">User Login Form</h2>
						<form action="${contextPath}/insurance/userlogin.htm"
							method="POST">
							<table>
								<tr>
									<td>Email:</td>
