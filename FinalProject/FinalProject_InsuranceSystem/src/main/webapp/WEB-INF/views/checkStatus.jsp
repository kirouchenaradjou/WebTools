...
<title>Insurance | Check Status</title>
...
<body>
	<div id="site-content">
		...
		<div class="breadcrumbs">
			<div class="container">
				<a href="${contextPath}/insurance/login.htm">Home</a> <span>Check Status</span>
			</div>
		</div>
		...
		<div class="page">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-9">
						<h2 class="section-title text-left">Welcome User - Check your status here </h2>
						...
						<form id="myForm">
							<table border="1px" cellpadding="0" cellspacing="0">
								<tr>
									<th>User ID</th>
									<th>Address</th>
									<th>Credit Card Number given</th>
									<th>Amount Sanctioned</th>
								</tr>

									<tr>
										<td>${requestScope.map.user.userID}</td>
										<td>${requestScope.map.user.address}</td>
										<td>${requestScope.map.user.creditCardNum}</td>
										<td>${requestScope.map.user.amount_sanctioned}</td>
										</tr>
							</table>
						</form>
